...
privileged aspect VetsItemVisitsThymeleafLinkFactory_Roo_LinkFactory {
     ...
     */
    public static final String VetsItemVisitsThymeleafLinkFactory.CREATE_FORM = "createForm";
    ...
    public UriComponents VetsItemVisitsThymeleafLinkFactory.toUri(String methodName, Object[] parameters, Map<String, Object> pathVariables) {
        ...
        if (methodName.equals(DATATABLES)) {
            return MvcUriComponentsBuilder.fromMethodCall(MvcUriComponentsBuilder.on(getControllerClass()).datatables(null, null, null, null, null)).buildAndExpand(pathVariables);
        }
