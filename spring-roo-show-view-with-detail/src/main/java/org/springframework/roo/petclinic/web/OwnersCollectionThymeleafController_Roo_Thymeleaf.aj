...
privileged aspect OwnersCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void OwnersCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            builder.addColumn(this.messageSource.getMessage("label_owner_id", null, "Id", locale), "id", Long.class.getName(), 50);
        }
        else if (columnName.equals("version")) {
            builder.addColumn(this.messageSource.getMessage("label_owner_version", null, "Version", locale), "version", Integer.class.getName(), 100);
        }
        else if (columnName.equals("firstName")) {
            builder.addColumn(this.messageSource.getMessage("label_owner_firstname", null, "First Ame", locale), "firstName", String.class.getName(), 100);
        }
        else if (columnName.equals("lastName")) {
            builder.addColumn(this.messageSource.getMessage("label_owner_lastname", null, "Last Ame", locale), "lastName", String.class.getName(), 100);
        }
        else if (columnName.equals("address")) {
            builder.addColumn(this.messageSource.getMessage("label_owner_address", null, "Address", locale), "address", String.class.getName(), 100);
        }
        else if (columnName.equals("city")) {
            builder.addColumn(this.messageSource.getMessage("label_owner_city", null, "City", locale), "city", String.class.getName(), 100);
        }
        else if (columnName.equals("telephone")) {
            builder.addColumn(this.messageSource.getMessage("label_owner_telephone", null, "Telephone", locale), "telephone", String.class.getName(), 100);
        }
        else if (columnName.equals("homePage")) {
            builder.addColumn(this.messageSource.getMessage("label_owner_homepage", null, "Home Age", locale), "homePage", String.class.getName(), 100);
        }
        else if (columnName.equals("email")) {
            builder.addColumn(this.messageSource.getMessage("label_owner_email", null, "Email", locale), "email", String.class.getName(), 100);
        }
        else if (columnName.equals("birthDay")) {
            builder.addColumn(this.messageSource.getMessage("label_owner_birthday", null, "Birth Ay", locale), "birthDay", Date.class.getName(), 100);
        }
        }
