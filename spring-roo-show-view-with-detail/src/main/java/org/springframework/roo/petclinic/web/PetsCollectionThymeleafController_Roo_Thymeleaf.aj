...
privileged aspect PetsCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void PetsCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            builder.addColumn(this.messageSource.getMessage("label_pet_id", null, "Id", locale), "id", Long.class.getName(), 50);
        }
        else if (columnName.equals("version")) {
            builder.addColumn(this.messageSource.getMessage("label_pet_version", null, "Version", locale), "version", Integer.class.getName(), 100);
        }
        else if (columnName.equals("sendReminders")) {
            builder.addColumn(this.messageSource.getMessage("label_pet_sendreminders", null, "Send Eminders", locale), "sendReminders", Boolean.class.getName(), 100);
        }
        else if (columnName.equals("name")) {
            builder.addColumn(this.messageSource.getMessage("label_pet_name", null, "Name", locale), "name", String.class.getName(), 100);
        }
        else if (columnName.equals("weight")) {
            builder.addColumn(this.messageSource.getMessage("label_pet_weight", null, "Weight", locale), "weight", Float.class.getName(), 100);
        }
        else if (columnName.equals("type")) {
            builder.addColumn(this.messageSource.getMessage("label_pet_type", null, "Type", locale), "type", PetType.class.getName(), 100);
        }
        }
