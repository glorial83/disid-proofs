...
privileged aspect PetsItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView PetsItemThymeleafController.update(@Valid @ModelAttribute Pet pet, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
