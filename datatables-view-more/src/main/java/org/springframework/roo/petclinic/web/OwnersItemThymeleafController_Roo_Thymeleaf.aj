...
privileged aspect OwnersItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView OwnersItemThymeleafController.update(@Valid @ModelAttribute Owner owner, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
