...
privileged aspect VisitsItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView VisitsItemThymeleafController.update(@Valid @ModelAttribute Visit visit, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
