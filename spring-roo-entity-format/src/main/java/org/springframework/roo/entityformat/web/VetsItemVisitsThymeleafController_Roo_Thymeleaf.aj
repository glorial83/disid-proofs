...
privileged aspect VetsItemVisitsThymeleafController_Roo_Thymeleaf {
     ...
     */
    @Autowired
    public VetsItemVisitsThymeleafController.new(VetService vetService, VisitService visitService, MessageSource messageSource, ControllerMethodLinkBuilderFactory linkBuilder) {
        this.vetService = vetService;
        this.visitService = visitService;
        this.messageSource = messageSource;
        this.collectionLink = linkBuilder.of(VetsCollectionThymeleafController.class);
    }
