...
import org.springframework.roo.entityformat.domain.Visit_Roo_Jaxb_Entity;
...
privileged aspect Visit_Roo_Jaxb_Entity {
    ...
    declare @type: Visit: @XmlRootElement(name = "visit", namespace = "http://ws.entityformat.roo.springframework.org/");
