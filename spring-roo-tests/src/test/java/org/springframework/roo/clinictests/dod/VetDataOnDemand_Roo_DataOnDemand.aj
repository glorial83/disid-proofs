...
privileged aspect VetDataOnDemand_Roo_DataOnDemand {
     ...
     * @param index
     */
    public void VetDataOnDemand.setCreatedBy(Vet obj, int index) {
     ...
     * @param index
     */
    public void VetDataOnDemand.setCreatedDate(Vet obj, int index) {
     ...
     * @param index
     */
    public void VetDataOnDemand.setModifiedBy(Vet obj, int index) {
     ...
     * @param index
     */
    public void VetDataOnDemand.setModifiedDate(Vet obj, int index) {
    ...
    public void VetDataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = vetRepository.findAll(new PageRequest(from / to, to)).getContent();
        if (data == null) {
