...
privileged aspect OwnerDataOnDemand_Roo_DataOnDemand {
     ...
     * @param index
     */
    public void OwnerDataOnDemand.setCreatedBy(Owner obj, int index) {
     ...
     * @param index
     */
    public void OwnerDataOnDemand.setCreatedDate(Owner obj, int index) {
     ...
     * @param index
     */
    public void OwnerDataOnDemand.setModifiedBy(Owner obj, int index) {
     ...
     * @param index
     */
    public void OwnerDataOnDemand.setModifiedDate(Owner obj, int index) {
    ...
    public void OwnerDataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = ownerRepository.findAll(new PageRequest(from / to, to)).getContent();
        if (data == null) {
