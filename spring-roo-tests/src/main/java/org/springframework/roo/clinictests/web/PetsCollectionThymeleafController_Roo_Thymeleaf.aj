...
import org.springframework.roo.clinictests.web.PetsCollectionThymeleafController;
import org.springframework.roo.clinictests.web.PetsItemThymeleafController;
import org.springframework.roo.clinictests.web.PetsItemThymeleafLinkFactory;
...
privileged aspect PetsCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void PetsCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_pet_sendreminders", null, "Send Eminders", locale), "sendReminders", Boolean.class.getName(), 100);
        }
            ...
            builder.addColumn(getMessageSource().getMessage("label_pet_createddate", null, "Created Ate", locale), "createdDate", Calendar.class.getName(), 100);
        }
        else if (columnName.equals("createdBy")) {
            builder.addColumn(getMessageSource().getMessage("label_pet_createdby", null, "Created Y", locale), "createdBy", String.class.getName(), 100);
        }
        else if (columnName.equals("modifiedDate")) {
            builder.addColumn(getMessageSource().getMessage("label_pet_modifieddate", null, "Modified Ate", locale), "modifiedDate", Calendar.class.getName(), 100);
        }
        else if (columnName.equals("modifiedBy")) {
            builder.addColumn(getMessageSource().getMessage("label_pet_modifiedby", null, "Modified Y", locale), "modifiedBy", String.class.getName(), 100);
        }
        }
