...
import org.springframework.roo.clinictests.domain.Visit_Roo_Jaxb_Entity;
...
privileged aspect Visit_Roo_Jaxb_Entity {
    ...
    declare @type: Visit: @XmlRootElement(name = "visit", namespace = "http://ws.clinictests.roo.springframework.org/");
