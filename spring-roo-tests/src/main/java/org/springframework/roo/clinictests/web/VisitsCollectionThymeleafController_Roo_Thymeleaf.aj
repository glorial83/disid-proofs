...
import org.springframework.roo.clinictests.web.VisitsCollectionThymeleafController;
import org.springframework.roo.clinictests.web.VisitsItemThymeleafController;
import org.springframework.roo.clinictests.web.VisitsItemThymeleafLinkFactory;
...
privileged aspect VisitsCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void VisitsCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_visit_visitdate", null, "Visit Ate", locale), "visitDate", Date.class.getName(), 100);
        }
        else if (columnName.equals("createdDate")) {
            builder.addColumn(getMessageSource().getMessage("label_visit_createddate", null, "Created Ate", locale), "createdDate", Calendar.class.getName(), 100);
        }
        else if (columnName.equals("createdBy")) {
            builder.addColumn(getMessageSource().getMessage("label_visit_createdby", null, "Created Y", locale), "createdBy", String.class.getName(), 100);
        }
        else if (columnName.equals("modifiedDate")) {
            builder.addColumn(getMessageSource().getMessage("label_visit_modifieddate", null, "Modified Ate", locale), "modifiedDate", Calendar.class.getName(), 100);
        }
        else if (columnName.equals("modifiedBy")) {
            builder.addColumn(getMessageSource().getMessage("label_visit_modifiedby", null, "Modified Y", locale), "modifiedBy", String.class.getName(), 100);
        }
        }
