...
privileged aspect PetWebServiceEndpoint_Roo_WS_Endpoint {
    ...
    declare @type: PetWebServiceEndpoint: @WebService(endpointInterface = "org.springframework.roo.clinictests.ws.api.PetWebService", portName = "PetWebServicePort", serviceName = "PetWebService", targetNamespace = "http://ws.clinictests.roo.springframework.org/");
