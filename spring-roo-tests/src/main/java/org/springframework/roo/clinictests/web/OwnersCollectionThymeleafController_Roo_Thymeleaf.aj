...
import org.springframework.roo.clinictests.web.OwnersItemThymeleafController;
import org.springframework.roo.clinictests.web.OwnersItemThymeleafLinkFactory;
...
privileged aspect OwnersCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void OwnersCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_owner_firstname", null, "First Ame", locale), "firstName", String.class.getName(), 100);
        }
        else if (columnName.equals("lastName")) {
            builder.addColumn(getMessageSource().getMessage("label_owner_lastname", null, "Last Ame", locale), "lastName", String.class.getName(), 100);
        }
            ...
            builder.addColumn(getMessageSource().getMessage("label_owner_homepage", null, "Home Age", locale), "homePage", String.class.getName(), 100);
        }
            ...
            builder.addColumn(getMessageSource().getMessage("label_owner_birthday", null, "Birth Ay", locale), "birthDay", Date.class.getName(), 100);
        }
        else if (columnName.equals("createdDate")) {
            builder.addColumn(getMessageSource().getMessage("label_owner_createddate", null, "Created Ate", locale), "createdDate", Calendar.class.getName(), 100);
        }
        else if (columnName.equals("createdBy")) {
            builder.addColumn(getMessageSource().getMessage("label_owner_createdby", null, "Created Y", locale), "createdBy", String.class.getName(), 100);
        }
        else if (columnName.equals("modifiedDate")) {
            builder.addColumn(getMessageSource().getMessage("label_owner_modifieddate", null, "Modified Ate", locale), "modifiedDate", Calendar.class.getName(), 100);
        }
        else if (columnName.equals("modifiedBy")) {
            builder.addColumn(getMessageSource().getMessage("label_owner_modifiedby", null, "Modified Y", locale), "modifiedBy", String.class.getName(), 100);
        }
        }
