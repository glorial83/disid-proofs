...
import org.springframework.roo.multiselect.domain.Visit_Roo_Jaxb_Entity;
...
privileged aspect Visit_Roo_Jaxb_Entity {
    ...
    declare @type: Visit: @XmlRootElement(name = "visit", namespace = "http://ws.multiselect.roo.springframework.org/");
