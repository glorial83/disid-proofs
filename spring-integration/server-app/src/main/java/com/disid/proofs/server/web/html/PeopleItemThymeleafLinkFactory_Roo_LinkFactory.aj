...
privileged aspect PeopleItemThymeleafLinkFactory_Roo_LinkFactory {
    
    declare parents: PeopleItemThymeleafLinkFactory implements MethodLinkFactory<PeopleItemThymeleafController>;
    
    declare @type: PeopleItemThymeleafLinkFactory: @Component;
     ...
     * 
     */
    public static final String PeopleItemThymeleafLinkFactory.UPDATE = "update";
     ...
     * @return Class
     */
    public Class<PeopleItemThymeleafController> PeopleItemThymeleafLinkFactory.getControllerClass() {
        return PeopleItemThymeleafController.class;
    }
