...
privileged aspect PeopleItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView PeopleItemThymeleafController.update(@Valid @ModelAttribute Person person, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
