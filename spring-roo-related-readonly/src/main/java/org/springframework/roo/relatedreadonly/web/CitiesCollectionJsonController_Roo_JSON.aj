...
import org.springframework.roo.relatedreadonly.web.CitiesCollectionJsonController;
...
privileged aspect CitiesCollectionJsonController_Roo_JSON {
    ...
    declare @type: CitiesCollectionJsonController: @RequestMapping(value = "/cities", name = "CitiesCollectionJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
