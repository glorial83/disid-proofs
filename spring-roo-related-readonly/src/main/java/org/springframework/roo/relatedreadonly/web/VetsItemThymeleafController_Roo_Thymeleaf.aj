...
privileged aspect VetsItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView VetsItemThymeleafController.update(@Valid @ModelAttribute Vet vet, @RequestParam("version") Integer version, BindingResult result, Model model) {
        if (result.hasErrors()) {
            populateForm(model);
