...
privileged aspect VisitsItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView VisitsItemThymeleafController.update(@Valid @ModelAttribute Visit visit, @RequestParam("version") Integer version, BindingResult result, Model model) {
        if (result.hasErrors()) {
            populateForm(model);
