...
privileged aspect BookServiceImpl_Roo_Service_Impl {
     ...
     * @return Page
     */
    public Page<Book> BookServiceImpl.findByAuthorsContains(Author authors, GlobalSearch globalSearch, Pageable pageable) {
        return getBookRepository().findByAuthorsContains(authors, globalSearch, pageable);
    }
